...
ACCOUNT_ID=$(terraform -chdir=infra/$INFRA_APP_NAME/envs/$ENV_NAME output -raw account_id)
...
terraform -chdir=infra/$INFRA_APP_NAME/envs/$ENV_NAME apply -auto-approve -var="image_tag=$IMAGE_TAG"
